 ...
 * @author Lay
 */
public abstract class AbstractMessageProvider<T extends BaseProviderConfig> implements MessageProvider {
    ...
    public void load() {
        ...
        if (index != null) {
            ...
            // emit index
            sourceLoader.onSourceIndex(index);
        }
    }
    ...
    public void warmUpAsync() {
        Thread warmThread = new Thread(this::warmUp, "Thread-WarmUp");
        warmThread.start();
    }
    ...
    protected void resolveIndexChanged(SourceIndex changedSourceIndex) {
        ...
        // emit index
        sourceLoader.onSourceIndex(changedSourceIndex);
    }
